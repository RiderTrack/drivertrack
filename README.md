...
- **🤖 Robot WhatsApp — cobro automático (F-ID5)**: apretás **🤖 Cobrar** y listo — tu rudy-bot (Termux, en el mismo teléfono) le manda al cliente el mensaje de pago **con la foto de tu QR de Yape adentro**, solo, sin abrir WhatsApp. Botón violeta mientras está activo, semáforo 🟢/🔴 en Ajustes con "Probar conexión", y si el robot no responde la app **abre WhatsApp como siempre** — el cobro nunca se traba. Requiere el parchecito F-ID5 en el bot (2 minutos, una sola vez)
...
>
> **F-ID5** 🤖 (cobro automático): 🤖 Cobrar → el cliente recibe el mensaje de pago **con tu QR de Yape como imagen** en su WhatsApp, mandado por tu rudy-bot (Termux, mismo teléfono — puente privado en 127.0.0.1:3001 con token, sin nube ni cuentas) · botón violeta + "Mandando…" con spinner y confirmación ✓ · semáforo 🟢/🔴 con "Probar conexión" en Ajustes · fallback automático a WhatsApp si el bot no responde · APK con cleartext SOLO para localhost (network security config)
>
